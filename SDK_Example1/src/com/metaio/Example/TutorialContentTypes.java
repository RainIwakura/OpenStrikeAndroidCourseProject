...
public class TutorialContentTypes extends ARViewActivity {
	...
	protected void loadContents() {
		//--------------
		// contentView is set by method getGUILayout() above
		// no need to setContentView(R.layout.tutorial_content_types);
		...
		try {
			...
			final String modelPath = AssetsManager.getAssetPath(
					...
					"TutorialContentTypes/Assets/metaioman.md2");
			if (modelPath != null) {
			...
			final String imagePath = AssetsManager.getAssetPath(
					getApplicationContext(),
					"TutorialContentTypes/Assets/frame.png");
			if (imagePath != null) {
			...
			final String moviePath = AssetsManager.getAssetPath(
					getApplicationContext(),
					"TutorialContentTypes/Assets/demo_movie.3g2");
			if (moviePath != null) {
			...
			final String truckPath = AssetsManager.getAssetPath(
					getApplicationContext(),
					"TutorialContentTypes/Assets/truck/truck.obj");
			if (truckPath != null) {
			...
			final String path = AssetsManager.getAssetPath(
					getApplicationContext(),
					"TutorialContentTypes/Assets/env_map.zip");
			if (path != null) {
				boolean loaded = metaioSDK.loadEnvironmentMap(path);
				MetaioDebug.log("Environment map loaded: " + loaded);
			} else {
				MetaioDebug.log(Log.ERROR, "Environment map not found at: "
						+ path);
			}
