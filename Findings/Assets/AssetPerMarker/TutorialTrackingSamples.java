...
//							"TutorialTrackingSamples/Assets/TrackingData_MarkerLess.xml");
			...
			final String imagePath = AssetsManager.getAssetPath(
					getApplicationContext(),
					"TutorialContentTypes/Assets/blood.png");
			if (imagePath != null) {
			...
			final String modelPath = AssetsManager.getAssetPath(getApplicationContext(), "TutorialContentTypes/Assets/health/health.md2");			
			if (modelPath != null) 
			{
